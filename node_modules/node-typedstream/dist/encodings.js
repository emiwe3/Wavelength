...
exports.allEncodingsMatchExpected = exports.encodingMatchesExpected = exports.buildStructEncoding = exports.parseStructEncoding = exports.buildArrayEncoding = exports.parseArrayEncoding = exports.joinEncodings = exports.splitEncodings = void 0;
/**
...
exports.splitEncodings = splitEncodings;
function joinEncodings(encodings) {
    return encodings.join("");
}
exports.joinEncodings = joinEncodings;
/**
...
exports.parseArrayEncoding = parseArrayEncoding;
...
exports.buildArrayEncoding = buildArrayEncoding;
/**
...
exports.parseStructEncoding = parseStructEncoding;
function buildStructEncoding(fieldTypeEncodings, name) {
    const fieldTypeEncodingString = joinEncodings(fieldTypeEncodings);
    return name == null
        ? '{' + fieldTypeEncodingString + "}"
        : '{' + name + '=' + fieldTypeEncodingString + '}';
}
exports.buildStructEncoding = buildStructEncoding;
function encodingMatchesExpected(actualEncoding, expectedEncoding) {
    if (actualEncoding.startsWith('{') && expectedEncoding.startsWith('{')) {
        ...
        return ((actualName == null || actualName == '?' || actualName == expectedName)
...
exports.encodingMatchesExpected = encodingMatchesExpected;
...
exports.allEncodingsMatchExpected = allEncodingsMatchExpected;
