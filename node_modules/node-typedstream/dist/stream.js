...
exports.TypedStreamReader = exports.EndStruct = exports.BeginStruct = exports.EndArray = exports.BeginArray = exports.ByteArray = exports.EndObject = exports.BeginObject = exports.SingleClass = exports.CString = exports.Selector = exports.Atom = exports.ObjectReference = exports.EndTypedValues = exports.BeginTypedValues = void 0;
 ...
 */
class BeginTypedValues {
    constructor(encodings) {
        this.encodings = encodings;
    }
}
exports.BeginTypedValues = BeginTypedValues;
/**
 ...
 */
class EndTypedValues {
}
exports.EndTypedValues = EndTypedValues;
/**
...
(function (ObjectReference) {
    ...
    (function (Type) {
        ...
        Type["CLASS"] = "class";
        Type["OBJECT"] = "object";
    })(Type = ObjectReference.Type || (ObjectReference.Type = {}));
...
exports.BeginStruct = BeginStruct;
/**
...
class TypedStreamReader {
     ...
     */
    constructor(data) {
        this.EOF_MESSAGE = "End of typedstream reached";
        this.pos = 0;
        this.data = data;
        ...
        if (signatureLength != SIGNATURE_LENGTH) {
            throw new InvalidTypedStreamError(`The signature string must be exactly ${SIGNATURE_LENGTH} bytes long, not ${signatureLength}`);
        }
    ...
    *readValueWithEncoding(typeEncoding, head) {
        ...
        if (typeEncoding == "C") {
            ...
            const { length, elementTypeEncoding } = (0, encodings_1.parseArrayEncoding)(typeEncoding);
            ...
            const { name, fieldTypeEncodings } = (0, encodings_1.parseStructEncoding)(typeEncoding);
    ...
    *readTypedValues(head, endOfStreamOk = false) {
        ...
        const encodingString = (_a = this.readSharedString(head)) === null || _a === void 0 ? void 0 : _a.toString('ascii');
        if (encodingString == null) {
            throw new InvalidTypedStreamError("Encountered nil type encoding string");
        }
        const typeEncodings = Array.from((0, encodings_1.splitEncodings)(encodingString));
...
exports.TypedStreamReader = TypedStreamReader;
